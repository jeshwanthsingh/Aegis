...
echo "It downloads release assets from: $RELEASE_URL"
echo "It verifies those assets against: $CHECKSUM_FILE"
echo "Use a checkout that matches the intended release asset set."
