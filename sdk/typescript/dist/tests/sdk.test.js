...
import { AegisAuthError, AegisClient, AegisConfigurationError, AegisExecutionError, AegisValidationError, BrokerScope, Budgets, DoneEvent, ExecutionRequest, IntentContract, NetworkScope, ProcessScope, ProofEvent, Receipt, ReceiptVerification, ReceiptVerifier, ResourceScope, StdoutEvent, } from "@aegis/sdk";
class TestServer {
    routes;
    requests = [];
    server;
