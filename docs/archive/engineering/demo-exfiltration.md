# Demo Exfiltration (Deprecated)

Deprecated. Do not use this as the Aegis demo walkthrough.

The older manual contrast flow was useful during earlier iterations, but it is not the packaged demo path the repo now leads with.
